...
CREATE TABLE [User] (
	...
	country varchar(256),
	is_email_notified boolean DEFAULT 'true',
...
CREATE TABLE [Schedule] (
	...
	start_term datetime,
	end_term datetime,
	is_every_day boolean DEFAULT 'false',
	is_every_week boolean DEFAULT 'false',
	is_every_month boolean DEFAULT 'false',
...
CREATE TABLE [ListFilter] (
	filter_id integer NOT NULL,
	is_show_completed binary NOT NULL DEFAULT 'true',
	is_ordered_by_term boolean NOT NULL DEFAULT 'false',
	is_ordered_by_prior boolean NOT NULL DEFAULT 'false',
	is_ordered_by_tag boolean NOT NULL DEFAULT 'false',
	selected_from_date date,
	selected_to_date date,
	selected_prior_id integer,
	selected_tag_id integer NOT NULL,
	is_only_favorites binary NOT NULL DEFAULT 'false',
...
GO
ALTER TABLE [Task] WITH CHECK ADD CONSTRAINT [Task_fk0] FOREIGN KEY ([list_id]) REFERENCES [TaskList]([list_id])
ON UPDATE CASCADE
GO
ALTER TABLE [Task] CHECK CONSTRAINT [Task_fk0]
GO
ALTER TABLE [Task] WITH CHECK ADD CONSTRAINT [Task_fk1] FOREIGN KEY ([schedule_id]) REFERENCES [Schedule]([schedule_id])
ON UPDATE CASCADE
GO
ALTER TABLE [Task] CHECK CONSTRAINT [Task_fk1]
GO
ALTER TABLE [Task] WITH CHECK ADD CONSTRAINT [Task_fk2] FOREIGN KEY ([priority_id]) REFERENCES [Priority]([priority_id])
ON UPDATE CASCADE
GO
ALTER TABLE [Task] CHECK CONSTRAINT [Task_fk2]
GO
ALTER TABLE [Task] WITH CHECK ADD CONSTRAINT [Task_fk3] FOREIGN KEY ([tag_id]) REFERENCES [Tag]([tag_id])
ON UPDATE CASCADE
GO
ALTER TABLE [Task] CHECK CONSTRAINT [Task_fk3]
GO
ALTER TABLE [Task] WITH CHECK ADD CONSTRAINT [Task_fk4] FOREIGN KEY ([status_id]) REFERENCES [Status]([status_id])
ON UPDATE CASCADE
GO
ALTER TABLE [Task] CHECK CONSTRAINT [Task_fk4]
GO
ALTER TABLE [Task] WITH CHECK ADD CONSTRAINT [Task_fk5] FOREIGN KEY ([user_id]) REFERENCES [User]([user_id])
ON UPDATE CASCADE
GO
ALTER TABLE [Task] CHECK CONSTRAINT [Task_fk5]
GO
ALTER TABLE [Task] WITH CHECK ADD CONSTRAINT [Task_fk6] FOREIGN KEY ([doer_id]) REFERENCES [Doer]([doer_id])
ON UPDATE CASCADE
GO
ALTER TABLE [Task] CHECK CONSTRAINT [Task_fk6]
GO



ALTER TABLE [File] WITH CHECK ADD CONSTRAINT [File_fk0] FOREIGN KEY ([task_id]) REFERENCES [Task]([task_id])
ON UPDATE CASCADE
GO
...
ALTER TABLE [Subtask] WITH CHECK ADD CONSTRAINT [Subtask_fk0] FOREIGN KEY ([task_id]) REFERENCES [Task]([task_id])
ON UPDATE CASCADE
GO
