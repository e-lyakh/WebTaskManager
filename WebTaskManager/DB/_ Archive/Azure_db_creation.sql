...
GO
ALTER TABLE [TaskItem] WITH CHECK ADD CONSTRAINT [TaskItem_fk1] FOREIGN KEY ([schedule_id]) REFERENCES [TaskSchedule]([schedule_id])
ON UPDATE CASCADE
GO
ALTER TABLE [TaskItem] CHECK CONSTRAINT [TaskItem_fk1]
GO
ALTER TABLE [TaskItem] WITH CHECK ADD CONSTRAINT [TaskItem_fk2] FOREIGN KEY ([priority_id]) REFERENCES [TaskPriority]([priority_id])
ON UPDATE CASCADE
GO
ALTER TABLE [TaskItem] CHECK CONSTRAINT [TaskItem_fk2]
GO
ALTER TABLE [TaskItem] WITH CHECK ADD CONSTRAINT [TaskItem_fk3] FOREIGN KEY ([tag_id]) REFERENCES [TaskTag]([tag_id])
ON UPDATE CASCADE
GO
ALTER TABLE [TaskItem] CHECK CONSTRAINT [TaskItem_fk3]
GO
ALTER TABLE [TaskItem] WITH CHECK ADD CONSTRAINT [TaskItem_fk4] FOREIGN KEY ([status_id]) REFERENCES [TaskStatus]([status_id])
ON UPDATE CASCADE
GO
...
ALTER TABLE [TaskFile] WITH CHECK ADD CONSTRAINT [TaskFile_fk0] FOREIGN KEY ([task_id]) REFERENCES [TaskItem]([task_id])
ON UPDATE CASCADE
GO
...
ALTER TABLE [ListFilter] WITH CHECK ADD CONSTRAINT [ListFilter_fk0] FOREIGN KEY ([selected_prior_id]) REFERENCES [TaskPriority]([priority_id])
ON UPDATE NO ACTION
GO
ALTER TABLE [ListFilter] CHECK CONSTRAINT [ListFilter_fk0]
GO
ALTER TABLE [ListFilter] WITH CHECK ADD CONSTRAINT [ListFilter_fk1] FOREIGN KEY ([selected_tag_id]) REFERENCES [TaskTag]([tag_id])
ON UPDATE NO ACTION
GO
